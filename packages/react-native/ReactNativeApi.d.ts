 ...
 *
 * @generated SignedSource<<0af08cff29a8d7c0fb6ea2b2f0eca9a8>>
 *
...
declare type TextInputBaseProps = {
  ...
  readonly editMenuItems?: ReadonlyArray<TextInputEditMenuItem>
  ...
  readonly onEditMenuItemPress?: (
    event: TextInputEditMenuItemPressEvent,
  ) => unknown
...
declare type TextInputEditMenuItem = {
  readonly id: string
  readonly title: string
}
declare type TextInputEditMenuItemPressEvent = NativeSyntheticEvent<{
  readonly eventCount: number
  readonly id: string
  readonly selection: Selection
  readonly target: number
...
export {
  ...
  TextInputEditMenuItem, // 0d0516f6
  TextInputEditMenuItemPressEvent, // f7e080b0
